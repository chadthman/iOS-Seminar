...
@synthesize greenViewController;
...
-(IBAction)toBlueButton
{
    ...
    [self.splitViewController.navigationController performSegueWithIdentifier:@"toBlue" sender: self.splitViewController];
...
//{
//    NSDate *object = _objects[indexPath.row];
//    self.redViewController.detailItem = object;
//}
